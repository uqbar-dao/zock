...
func main{output_ptr : felt*, pedersen_ptr : HashBuiltin*}():
  ...
  let (h_a4) = hash_noun{hp=pedersen_ptr}(n=&a2)
  let (h_a5) = hash_noun{hp=pedersen_ptr}(n=&a3)
  let (h_a6) = hash_noun{hp=pedersen_ptr}(n=&a2)
  let (h_a7) = hash_noun{hp=pedersen_ptr}(n=&a3)
  let (h_n2_3) = hash_noun{hp=pedersen_ptr}(n=&n2_3)
  let (h_n4_5) = hash_noun{hp=pedersen_ptr}(n=&n6_7)
